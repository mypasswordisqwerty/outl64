...
typedef struct _Outl64FuzzLib_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } Outl64FuzzLib_MIDL_TYPE_FORMAT_STRING;

typedef struct _Outl64FuzzLib_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } Outl64FuzzLib_MIDL_PROC_FORMAT_STRING;

typedef struct _Outl64FuzzLib_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } Outl64FuzzLib_MIDL_EXPR_FORMAT_STRING;
...
extern const Outl64FuzzLib_MIDL_TYPE_FORMAT_STRING Outl64FuzzLib__MIDL_TypeFormatString;
extern const Outl64FuzzLib_MIDL_PROC_FORMAT_STRING Outl64FuzzLib__MIDL_ProcFormatString;
extern const Outl64FuzzLib_MIDL_EXPR_FORMAT_STRING Outl64FuzzLib__MIDL_ExprFormatString;
...
extern const MIDL_SERVER_INFO IMapiFuzz_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IMapiFuzz_ProxyInfo;
...
static const Outl64FuzzLib_MIDL_PROC_FORMAT_STRING Outl64FuzzLib__MIDL_ProcFormatString =
    {
        0,
        {
...
/* 252 */	NdrFcShort( 0x3fa ),	/* Type Offset=1018 */
...
/* 268 */	NdrFcShort( 0x28 ),	/* X64 Stack size/offset = 40 */
...
/* 290 */	NdrFcShort( 0x40c ),	/* Type Offset=1036 */

	/* Parameter mockMessage */
...
/* 306 */	NdrFcShort( 0x20 ),	/* X64 Stack size/offset = 32 */
/* 308 */	0x8,		/* FC_LONG */
			0x0,		/* 0 */
...
/* 378 */	NdrFcShort( 0x40c ),	/* Type Offset=1036 */
...
/* 406 */	0x46,		/* Oi2 Flags:  clt must size, has return, has ext, */
			0x3,		/* 3 */
/* 408 */	0xa,		/* 10 */
			0x85,		/* Ext Flags:  new corr desc, srv corr check, has big amd64 byval param */
...
/* 422 */	NdrFcShort( 0x40c ),	/* Type Offset=1036 */
...
static const Outl64FuzzLib_MIDL_TYPE_FORMAT_STRING Outl64FuzzLib__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* 1032 */	
			0x12, 0x0,	/* FC_UP */
/* 1034 */	NdrFcShort( 0xfec2 ),	/* Offset= -318 (716) */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    Outl64FuzzLib__MIDL_ProcFormatString.Format,
...
/* Object interface: IMapiFuzz, ver. 0.0,
   GUID={0x7CEECFDA,0x32C6,0x4592,{0xBE,0x27,0xA8,0x81,0xE1,0x96,0x7F,0xC4}} */

#pragma code_seg(".orpc")
static const unsigned short IMapiFuzz_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IMapiFuzz_ProxyInfo =
    {
    &Object_StubDesc,
    Outl64FuzzLib__MIDL_ProcFormatString.Format,
    &IMapiFuzz_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IMapiFuzz_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    Outl64FuzzLib__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(13) _IMapiFuzzProxyVtbl = 
{
    &IMapiFuzz_ProxyInfo,
    &IID_IMapiFuzz,
    IUnknown_QueryInterface_Proxy,
    ...
    0 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* IMapiFuzz::version */ ,
    (void *) (INT_PTR) -1 /* IMapiFuzz::parseTnef */ ,
    (void *) (INT_PTR) -1 /* IMapiFuzz::config */ ,
    (void *) (INT_PTR) -1 /* IMapiFuzz::createMessage */ ,
    (void *) (INT_PTR) -1 /* IMapiFuzz::parseCert */ ,
    (void *) (INT_PTR) -1 /* IMapiFuzz::crash */
};


static const PRPC_STUB_FUNCTION IMapiFuzz_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IMapiFuzzStubVtbl =
{
    &IID_IMapiFuzz,
    &IMapiFuzz_ServerInfo,
    13,
    &IMapiFuzz_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    Outl64FuzzLib__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _Outl64FuzzLib_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IMapiFuzzProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _Outl64FuzzLib_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    ( CInterfaceStubVtbl *) &_IMapiFuzzStubVtbl,
    0
...
PCInterfaceName const _Outl64FuzzLib_InterfaceNamesList[] = 
{
    "IComponentRegistrar",
    "IMapiFuzz",
    0
...
const IID *  const _Outl64FuzzLib_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _Outl64FuzzLib_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _Outl64FuzzLib, pIID, n)

int __stdcall _Outl64FuzzLib_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _Outl64FuzzLib, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _Outl64FuzzLib, 2, *pIndex )
    
}

const ExtendedProxyFileInfo Outl64FuzzLib_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _Outl64FuzzLib_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _Outl64FuzzLib_StubVtblList,
    (const PCInterfaceName * ) & _Outl64FuzzLib_InterfaceNamesList,
    (const IID ** ) & _Outl64FuzzLib_BaseIIDList,
    & _Outl64FuzzLib_IID_Lookup, 
    2,
    2,
